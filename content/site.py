...
NAV = [
    ...
    ("지역별 안내", "/mapo-gu/", [
        ("마포구 전체", "/mapo-gu/"),
        ("아현동", "/mapo-gu/ahyeon-dong/"),
        ("공덕동", "/mapo-gu/gongdeok-dong/"),
        ("도화동", "/mapo-gu/dohwa-dong/"),
        ("용강동", "/mapo-gu/yonggang-dong/"),
        ("대흥동", "/mapo-gu/daeheung-dong/"),
        ("염리동", "/mapo-gu/yeomni-dong/"),
        ("신수동", "/mapo-gu/sinsu-dong/"),
        ("서강동", "/mapo-gu/seogang-dong/"),
        ("서교동", "/mapo-gu/seogyo-dong/"),
        ("합정동", "/mapo-gu/hapjeong-dong/"),
        ("망원동", "/mapo-gu/mangwon-dong/"),
        ("연남동", "/mapo-gu/yeonnam-dong/"),
        ("성산동", "/mapo-gu/seongsan-dong/"),
        ("상암동", "/mapo-gu/sangam-dong/"),
    ]),
    ("지하철역별 안내", "/mapo-gu/stations/", [
        ("역 전체", "/mapo-gu/stations/"),
        ("홍대입구역", "/mapo-gu/stations/hongik-univ-station/"),
        ("합정역", "/mapo-gu/stations/hapjeong-station/"),
        ("공덕역", "/mapo-gu/stations/gongdeok-station/"),
        ("마포역", "/mapo-gu/stations/mapo-station/"),
        ("마포구청역", "/mapo-gu/stations/mapo-gu-office-station/"),
        ("망원역", "/mapo-gu/stations/mangwon-station/"),
        ("상수역", "/mapo-gu/stations/sangsu-station/"),
        ("광흥창역", "/mapo-gu/stations/gwangheungchang-station/"),
        ("대흥역", "/mapo-gu/stations/daeheung-station/"),
        ("월드컵경기장역", "/mapo-gu/stations/world-cup-stadium-station/"),
        ("디지털미디어시티역", "/mapo-gu/stations/digital-media-city-station/"),
        ("서강대역", "/mapo-gu/stations/sogang-univ-station/"),
        ("신촌역", "/mapo-gu/stations/sinchon-station/"),
        ("이대역", "/mapo-gu/stations/ewha-womans-univ-station/"),
        ("아현역", "/mapo-gu/stations/ahyeon-station/"),
        ("애오개역", "/mapo-gu/stations/aeogae-station/"),
    ]),
    ("테마별 안내", "/themes/", [
        ("전체 테마", "/themes/"),
        ("스웨디시", "/themes/swedish/"),
